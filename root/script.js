...
playlistBtn.addEventListener(`click`, function(e) {
    e.preventDefault();
    playlist = [];
    fetch(`https://nwencore.herokuapp.com/process_get?link=${playlistInput.value}`, {mode: 'no-cors'})
        .then((response) => {
...
playBtn.addEventListener("click", (e) => {
    e.preventDefault();
    playlist = [];
    fetch(`https://nwencore.herokuapp.com/process_get?link=https://open.spotify.com/playlist/3XM4qNNOrn2PcaiyIe8nax?si=81ef02f784c64af7`, {mode: 'no-cors'}).then((response) => {
...
answerButton.addEventListener("click",
    function (e){
        ...
        fetch (`https://nwencore.herokuapp.com/song?guess=${songInput}&ans=${currentSong.track_name}`)
