...
playlistBtn.addEventListener(`click`, function(e) {
    e.preventDefault();
    playlist = [];
    fetch(`https://nwencore.herokuapp.com/process_get?link=${playlistInput.value}`,)
        .then((response) => {
...
playBtn.addEventListener("click", (e) => {
    e.preventDefault();
    playlist = [];
    fetch(`https://nwencore.herokuapp.com/process_get?link=https://open.spotify.com/playlist/3XM4qNNOrn2PcaiyIe8nax?si=81ef02f784c64af7`, ).then((response) => {
